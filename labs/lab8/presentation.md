...
subtitle: Статья В.В. Рыкова и Э.Е. Лемберга
author:
  - Легиньких Г.А.
institute:
...
## Слайд 9: Основное уравнение баланса
...
Берём производные от уравнения (слайд 9) по $z_1$ и $z_2$, подставляем $z_1 = z_2 = 1$
...
**Данные:**
| Тип | $\lambda_i$ (зв./час) | $b_i$ (мин) | $a_i$ (руб/мин) |
|-----|----------------------|-------------|-----------------|
| VIP | 2 | 5 | 100 |
| Постоянные | 4 | 8 | 40 |
| Новые | 6 | 10 | 10 |
